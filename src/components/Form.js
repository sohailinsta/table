...
/*const [modal, setModal] = useState(false);
  ...
  <option value="J_12948">J_12948</option>
      ...
      <td className="dxc">pending <img className="pending-set" src="https://png.pngtree.com/png-vector/20200224/ourmid/pngtree-colorful-loading-icon-png-image_2152960.jpg" alt="selected"/></td>
      <td className="dxc">04/03/2022 5:30-6:30 <img className="pending-set" src="https://png.pngtree.com/png-vector/20200224/ourmid/pngtree-colorful-loading-icon-png-image_2152960.jpg" alt="selected"/></td>
      <td className="dxc">pending <img className="pending-set" src="https://png.pngtree.com/png-vector/20200224/ourmid/pngtree-colorful-loading-icon-png-image_2152960.jpg" alt="selected"/></td>
      <td className="dxc">no
...
<div class="modal fade container" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <option value="mango">J_12948</option>
      ...
      <td className="forwarded-yes dxc">03/03/2022</td>
      <td className="dxc">yes</td>
      <td className="dxc">04/03/2022  5:30-6:30   <img className="rejected-set" src="https://png.pngtree.com/png-vector/20190618/ourmid/pngtree-true-and-false-symbols-accept-rejected-for-evaluation-vector-simple-png-image_1502129.jpg" alt="rejected"/></td>
      <td className="dxc"> pending <img className="pending-set" src="https://png.pngtree.com/png-vector/20200224/ourmid/pngtree-colorful-loading-icon-png-image_2152960.jpg" alt="selected"/></td>
      <td className="dxc">04/13/2022 4:30-5:30 <img className="rejected-set" src="https://png.pngtree.com/png-vector/20190618/ourmid/pngtree-true-and-false-symbols-accept-rejected-for-evaluation-vector-simple-png-image_1502129.jpg" alt="rejected"/></td>
      <td className="dxc">rejected <img className="rejected-set" src="https://png.pngtree.com/png-vector/20190618/ourmid/pngtree-true-and-false-symbols-accept-rejected-for-evaluation-vector-simple-png-image_1502129.jpg" alt="rejected"/></td>
      <td className="dxc">04/07/2022 4:30-5:30 <img className="rejected-set" src="https://png.pngtree.com/png-vector/20190618/ourmid/pngtree-true-and-false-symbols-accept-rejected-for-evaluation-vector-simple-png-image_1502129.jpg" alt="rejected"/></td>
      <td className="dxc">rejected <img className="rejected-set" src="https://png.pngtree.com/png-vector/20190618/ourmid/pngtree-true-and-false-symbols-accept-rejected-for-evaluation-vector-simple-png-image_1502129.jpg" alt="rejected"/></td>
      <td className="dxc">no</td>
      <td className="dxc">yes
      <button type="button" class="btn btn-primary btn-reason" data-bs-toggle="modal" data-bs-target="#exampleModal">
...
<div class="modal fade container" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <option value="mango">J_12948</option>
      ...
      <td className="dxc">04/03/2022  5:30-6:30 <img className="rejected-set" src="https://png.pngtree.com/png-vector/20190618/ourmid/pngtree-true-and-false-symbols-accept-rejected-for-evaluation-vector-simple-png-image_1502129.jpg" alt="rejected"/></td>
      <td className="dxc">rejected <img className="rejected-set" src="https://png.pngtree.com/png-vector/20190618/ourmid/pngtree-true-and-false-symbols-accept-rejected-for-evaluation-vector-simple-png-image_1502129.jpg" alt="rejected"/></td>
      <td className="dxc">04/03/2022 2:30-3:30 <img className="rejected-set" src="https://png.pngtree.com/png-vector/20190618/ourmid/pngtree-true-and-false-symbols-accept-rejected-for-evaluation-vector-simple-png-image_1502129.jpg" alt="rejected"/></td>
      <td className="dxc">rejected <img className="rejected-set" src="https://png.pngtree.com/png-vector/20190618/ourmid/pngtree-true-and-false-symbols-accept-rejected-for-evaluation-vector-simple-png-image_1502129.jpg" alt="rejected"/></td>
      <td className="dxc">04/03/2022 5:30-6:30 <img className="rejected-set" src="https://png.pngtree.com/png-vector/20190618/ourmid/pngtree-true-and-false-symbols-accept-rejected-for-evaluation-vector-simple-png-image_1502129.jpg" alt="rejected"/></td>
      <td className="dxc">rejected <img className="rejected-set" src="https://png.pngtree.com/png-vector/20190618/ourmid/pngtree-true-and-false-symbols-accept-rejected-for-evaluation-vector-simple-png-image_1502129.jpg" alt="rejected"/></td>
      <td className="dxc">yes
